...
<li> <a href="new_student.php"> <i class="menu-icon fa fa-caret-right"></i> New Admission </a> <b class="arrow"></b> </li>
<li class="active"> <a href="#"> <i class="menu-icon fa fa-caret-right"></i> Student Information </a> <b class="arrow"></b> </li>
</ul>
</li>
...
<li> <a href="../Employee/student_information.php"> <i class="menu-icon fa fa-caret-right"></i> Employee Information </a> <b class="arrow"></b> </li>
</ul>
</li>
...
<input type="text" placeholder="Search ..." class="nav-search-input student_search" id="search_value" autocomplete="off" />
...
============================================================================================================ -->
<?php include 'student_information_working_page_area.php'; ?>
<!-- ===========================================================================================================
...
<script src="../JS_Connect_DB/StudentInformationJS.js"></script>
