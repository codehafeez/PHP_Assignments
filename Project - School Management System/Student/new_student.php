...
<li class="active"> <a href="#"> <i class="menu-icon fa fa-caret-right"></i> New Admission </a> <b class="arrow"></b> </li>
<li> <a href="student_information.php"> <i class="menu-icon fa fa-caret-right"></i> Student Information </a> <b class="arrow"></b> </li>
</ul>
</li>
...
============================================================================================================ -->
<?php include 'new_student_working_page_area.php'; ?>
<!-- ===========================================================================================================
...
<script src="../JS_Connect_DB/AdmissionJS.js"></script>
