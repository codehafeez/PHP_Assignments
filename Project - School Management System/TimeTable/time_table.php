...
<li> <a href="../Student/new_student.php"> <i class="menu-icon fa fa-caret-right"></i> New Admission </a> <b class="arrow"></b> </li>
...
<li> <a href="../Account/salary_acount.php"> <i class="menu-icon fa fa-caret-right"></i> Salary </a> <b class="arrow"></b> </li>
...
<span class="menu-text"> Time Table </span> <b class="arrow fa fa-angle-down"></b> </a> <b class="arrow"></b>
<ul class="submenu nav-show">
<li> <a href="class1_time_table.php"> <i class="menu-icon fa fa-caret-right"></i> Class 1 </a> <b class="arrow"></b> </li>
<li> <a href="class2_time_table.php"> <i class="menu-icon fa fa-caret-right"></i> Class 2 </a> <b class="arrow"></b> </li>
<li> <a href="class3_time_table.php"> <i class="menu-icon fa fa-caret-right"></i> Class 3 </a> <b class="arrow"></b> </li>
<li> <a href="class4_time_table.php"> <i class="menu-icon fa fa-caret-right"></i> Class 4 </a> <b class="arrow"></b> </li>
<li> <a href="class5_time_table.php"> <i class="menu-icon fa fa-caret-right"></i> Class 5 </a> <b class="arrow"></b> </li>
</ul>
</li>
...
============================================================================================================ -->
<?php include 'time_table_working_page_area.php'; ?>
<!-- ===========================================================================================================
...
<script src="../JS_Connect_DB/TimeTableJS.js"></script>
</body>
</html>
