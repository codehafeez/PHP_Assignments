...
<ul class="submenu nav-show">
<li class="active"> <a href="#"> <i class="menu-icon fa fa-caret-right"></i> Add New Employee </a> <b class="arrow"></b> </li>
<li> <a href="employee_information.php"> <i class="menu-icon fa fa-caret-right"></i> Employee Information </a> <b class="arrow"></b> </li>
</ul>
</li>
...
============================================================================================================ -->
<?php include 'new_employee_working_page_area.php'; ?>
<!-- ===========================================================================================================
...
<script src="../JS_Connect_DB/AddEmployeeJS.js"></script>
