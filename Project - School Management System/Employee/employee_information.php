...
<ul class="submenu nav-show">
<li> <a href="new_employee.php"> <i class="menu-icon fa fa-caret-right"></i> Add New Employee </a> <b class="arrow"></b> </li>
<li class="active"> <a href="#"> <i class="menu-icon fa fa-caret-right"></i> Employee Information </a> <b class="arrow"></b> </li>
</ul>
</li>
...
<input type="text" placeholder="Search ..." class="nav-search-input employee_search" id="search_value_employee" name="search_value_employee" autocomplete="off" />
...
============================================================================================================ -->
<?php include 'employee_information_working_page_area.php'; ?>
<!-- ===========================================================================================================
...
<script src="../JS_Connect_DB/EmployeeInformationJS.js"></script>
