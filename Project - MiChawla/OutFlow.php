...
<?php include_once './header.php';?>
    <script src="js/OutFlowJS.js"></script>   
</head>
...
<center><h3 class="box-title" id="Balance"></h3></center>
...
<button type="button" class="btn btn-primary pull-right" id="recoverybtn" style="margin-top: 10px; margin-bottom: 10px;">Add Cash Entry</button>    
...
<div class="box-body">
<div class="input-group">
<input type="hidden" id="dateid" value='<?php echo date('d-M-Y');?>'>    
...
<br>
<div class="input-group">
<label class="form-check-label">Select The Walk</label>
<div id="walklist" style="margin-left: 20px;"></div>
</div>
<div class="input-group">
<label class="form-check-label">Select The Member</label>
...
<input type="date" id="cashdateamount" class="form-control" placeholder="Amount" >
</div>
<br>
<div class="input-group">
<span class="input-group-addon"><i class="fa fa-money"></i></span>
...
<div class="input-group">
<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
<input type="date" id="bankdateamount" class="form-control" placeholder="date" >
</div>
<br>
<div class="input-group">
